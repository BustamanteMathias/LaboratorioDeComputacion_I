...
int main(void) {
	...
	eProducto productos[MAX_ESTRUCTURA] = { { 1, "DESCRIPCION 1", EEUU, IPHONE,
			5000, OCUPADO }, { 2, "DESCRIPCION 2", OTRO, IPAD, 10500, OCUPADO },
			{ 3, "DESCRIPCION 3", CHINA, ACCESORIOS, 5000, OCUPADO }, { 4,
					"DESCRIPCION 4", CHINA, ACCESORIOS, 10000, OCUPADO } };
